...
import { getLeaderboard, submitScores, getWorldRecordSheet, getWorldRecordReplay, getMarblelandLeaderboard } from './leaderboard';
			...
			try {
				...
				if (pathComponents[0] === 'api') {
					...
					switch (pathComponents[1]) {
						...
						case 'marbleland_scores': await getMarblelandLeaderboard(res, urlObject); break;
